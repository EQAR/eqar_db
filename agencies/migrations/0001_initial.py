    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stage', uni_db.fields.EnumField(choices=[('1. Analysis by Secretariat', '1. Analysis by Secretariat'), ('2. Sent to rapporteurs', '2. Sent to rapporteurs'), ('3. Waiting RC consideration', '3. Waiting RC consideration'), ('4. Completed', '4. Completed')], default='1. Analysis by Secretariat')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submit_date', models.DateField(blank=True, db_column='submitDate', null=True)),
                ('type', uni_db.fields.EnumField(choices=[('Initial', 'Initial application for registration'), ('Renewal', 'Application for renewal of registration')], default='Initial')),
                ...
                ('panel_2_1', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
                ('panel_2_2', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
                ('panel_2_3', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
                ('panel_2_4', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
                ('panel_2_5', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
                ('panel_2_6', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
                ('panel_2_7', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
                ('panel_3_1', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
                ('panel_3_2', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
                ('panel_3_3', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
                ('panel_3_4', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
                ('panel_3_5', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
                ('panel_3_6', uni_db.fields.EnumField(blank=True, choices=[('Full compliance', 'Full compliance'), ('Substantial compliance', 'Substantial compliance'), ('Partial compliance', 'Partial compliance'), ('Non-compliance', 'Non-compliance')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', uni_db.fields.EnumField(choices=[('Panel member', 'Panel member'), ('Panel chair', 'Panel chair'), ('Panel secretary', 'Panel secretary'), ('Coordinator', 'Coordinator'), ('Other', 'Other')], default='Panel member')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', uni_db.fields.EnumField(choices=[('Panel', 'Panel'), ('Coordinator', 'Coordinator'), ('Agency', 'Agency'), ('Other', 'Other')], default='Panel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', uni_db.fields.EnumField(choices=[('institutional', 'Instituional reviews'), ('programme', 'Programme-level reviews'), ('joint programme', 'Joint programme reviews')], default='institutional')),
                ('amount', models.IntegerField(blank=True, null=True)),
                ('cross_border', models.BooleanField(db_column='crossBorder', default=False)),
                ('source', uni_db.fields.EnumField(choices=[('DEQAR', 'Reports in DEQAR'), ('form', 'Annual survey')], default='DEQAR')),
                ('mtime', models.DateTimeField(auto_now=True)),
